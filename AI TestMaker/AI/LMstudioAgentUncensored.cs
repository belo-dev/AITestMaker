...
public class LMStudioAgentUncensored : IAgent
{
    private readonly HttpClient _http = new HttpClient();
    private readonly string _endpoint;
    private readonly string _model;

    public string Nombre => "LMStudioUncensored";

    public LMStudioAgentUncensored(
        string endpoint = "https://ia.belo-dev.site/v1/chat/completions",
        string model = "qwen2.5-coder-32b-instruct-uncensored")
    {
